...
namespace GhostLyzer.Module.GhostApi.ContractResolvers
{
    public class UpdatePageContractResolver : DefaultContractResolver
    {
        ...
        private static readonly Lazy<UpdatePageContractResolver> lazy = new Lazy<UpdatePageContractResolver>(() => new UpdatePageContractResolver());

        // Public accessor for the singleton instance
        public static UpdatePageContractResolver Instance { get { return lazy.Value; } }

        // Private constructor to prevent direct instantiation
        private UpdatePageContractResolver() { }
