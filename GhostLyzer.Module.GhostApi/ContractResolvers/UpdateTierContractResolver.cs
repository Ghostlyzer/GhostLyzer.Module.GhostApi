...
namespace GhostLyzer.Module.GhostApi.ContractResolvers
{
    public class UpdateTierContractResolver : DefaultContractResolver
    {
        ...
        private static readonly Lazy<UpdateTierContractResolver> lazy = new Lazy<UpdateTierContractResolver>(() => new UpdateTierContractResolver());

        // Public accessor for the singleton instance
        public static UpdateTierContractResolver Instance { get { return lazy.Value; } }

        // Private constructor to prevent direct instantiation
        private UpdateTierContractResolver() { }
